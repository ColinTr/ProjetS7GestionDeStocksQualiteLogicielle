...
public class produitDAOSteps {
    ...
    public void setNbProduitsDansBdd(int arg0) {
        ...
        for (int i = 0; i < arg0; i++) {
            Produit p = new Produit(RandomStringUtils.randomAlphanumeric(10), new Random().nextInt(101 + 1), new Random().nextInt(101 + 1), new Random().nextInt(101 + 1),null,null,null);
            em.persist(p);
        }
    ...
    public void onRemplieLaListeBDDAvecProduitsQuiNeSontPasSurLaBDD(int arg0) {
        for (int i = 0; i < arg0; i++) {
            listProduitBDD.add(new Produit(RandomStringUtils.randomAlphanumeric(10), new Random().nextInt(101 + 1), new Random().nextInt(101 + 1), new Random().nextInt(101 + 1), null,null,null));
        }
    }
}